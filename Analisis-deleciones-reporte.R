...
#guardar tabla
write.table(Tabla_heatmap, file="C:/Users/Jose Abel/OneDrive - UNIVERSIDAD NACIONAL AUTÓNOMA DE MÉXICO/Tesis_sobre_SARS-CoV-2/Tesis-BetterLab/deleciones-analisis-R/Tabla_heatmap.txt", sep = ",")
